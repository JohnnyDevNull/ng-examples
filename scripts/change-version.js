/*
 * Helper script for changing all necessary version files
 */
...
try {
  ...
  const packageFiles = [
    {name: 'project 1', path: '../projects/project-1/package.json', contentJSON: null},
    {name: 'project 1 lockfile', path: '../projects/project-1/package-lock.json', contentJSON: null},
    {name: 'library', path: '../projects/library/package.json', contentJSON: null},
  ];
  ...
  const questions = [{
    ...
    // Die Eingabe darf leer sein oder muss dem Format entsprechen
    validate: v => v == null
      || v.toString().length === 0
